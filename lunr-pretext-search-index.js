...
},
{
  ...
  "number": "4.2.1",
  "title": "",
  "body": "      Strategy    is odd   Factor out a term.  Convert the remaining even power of to using the Pythagorean identity  Then use -sub that      is odd   Factor out a term.  Convert the remaining even power of to using the Pythagorean identity  Then use -sub that      "
},
{
